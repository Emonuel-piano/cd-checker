...
input_app_id = st.sidebar.text_input("アプリケーションID (UUID)", value="1944c4fa-f957-4985-a6d2-02d3ad38f477", type="password")
input_access_key = st.sidebar.text_input("アクセスキー (pk_...)", type="password")
